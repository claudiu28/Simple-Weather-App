...
def WeatherApp(request):
    try:
        ...
        if request.method == 'POST':
            ...
            source = urllib.request.urlopen('https://api.openweathermap.org/data/2.5/weather?q=' + encode_city + '&units=metric&appid=' + API_KEY).read()
        ...
        error_context = "Plese introduce valid name of city, your data was not found!!!"
